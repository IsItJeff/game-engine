...
// Collect loot: a player overlapping a Pickup restores its `heal` health (capped) and
// consumes it. Lets kills sustain you. Collect-then-destroy, like resolve_contacts.
