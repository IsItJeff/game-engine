...
void draw_debug_panel(const eng::sim::World& world, bool& paused) {
  ...
  ImGui::TextWrapped(
      ...
      "(permadeath) — you respawn. Creatures hunt you and hit back: RED brutes are "
      "slow, tanky, and hit hard, while ORANGE swarmers are fast and fragile but come "
      "in numbers. Fresh ones keep arriving (the NPCs pitch in and fight them too). "
